...
export default function wywInJS({
  ...
  return {
    ...
    async transform(code, url, transformOptions) {
      ...
      const result = await transform(transformServices, code, createAsyncResolver(getBoundResolve(this)));
      let {
        cssText,
        dependencies
      } = result;
