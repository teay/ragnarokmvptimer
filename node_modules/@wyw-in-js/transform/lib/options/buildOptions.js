...
const extractPackageNameFromPath = key => {
  ...
  return (_match$ = match === null || match === void 0 ? void 0 : match[1]) !== null && _match$ !== void 0 ? _match$ : null;
};
...
const mergeConfigItems = (kind, source, overrides) => {
  const combined = [...(source !== null && source !== void 0 ? source : []), ...(overrides !== null && overrides !== void 0 ? overrides : [])];
  return combined.reduce((reduction, override) => {
    ...
    const baseKey = (_getItemKey = getItemKey(base)) !== null && _getItemKey !== void 0 ? _getItemKey : overrideKey;
...
const babelMerge = (source, overrides) => {
  ...
  const envNames = new Set([...Object.keys(sourceEnv !== null && sourceEnv !== void 0 ? sourceEnv : {}), ...Object.keys(overridesEnv !== null && overridesEnv !== void 0 ? overridesEnv : {})]);
  if (envNames.size) {
    merged.env = {};
    for (const name of envNames) {
      var _sourceEnv$name, _overridesEnv$name;
      merged.env[name] = babelMerge((_sourceEnv$name = sourceEnv === null || sourceEnv === void 0 ? void 0 : sourceEnv[name]) !== null && _sourceEnv$name !== void 0 ? _sourceEnv$name : {}, (_overridesEnv$name = overridesEnv === null || overridesEnv === void 0 ? void 0 : overridesEnv[name]) !== null && _overridesEnv$name !== void 0 ? _overridesEnv$name : {});
    }
  }
  return merged;
};
