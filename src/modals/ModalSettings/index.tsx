...
export function ModalSettings({ onClose }: Props) {
  ...
  const confirmationDescription = intl.formatMessage({
    id: 'clear_data_description',
  });
          ...
          <SettingsContainer>
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='ultra_lite'
                  defaultMessage='Ultra Lite Mode (Extreme Performance)'
                />
              </SettingName>
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='simple_glass_ui'
                  defaultMessage='Simple Glass UI (Best Performance)'
                />
              </SettingName>
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='hide_active_content'
                  defaultMessage='Hide Active Content'
                />
              </SettingName>
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  ...
                  defaultMessage='Animated Background'
                />
              </SettingName>
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='animated_background_color'
                  defaultMessage='Animated Background Color'
                />
              </SettingName>
              <input
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='animated_background_opacity'
                  defaultMessage='Animated Background Color Opacity'
                />
              </SettingName>
              <input
                ...
                onChange={(e) =>
                  changeAnimatedBackgroundOpacity(Number(e.target.value))
                }
              />
            </Setting>
            ...
            {isSparkleEffectEnabled && (
              <Setting>
                <SettingName>
                  <FormattedMessage
                    id='sparkle_density'
                    defaultMessage='Sparkle Density'
                  />
                </SettingName>
                <select
                  id='sparkleDensity'
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='falling_elements'
                  defaultMessage='Falling Elements'
                />
              </SettingName>
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='background_effect_mode'
                  defaultMessage='Effect Mode'
                />
              </SettingName>
              <select
                ...
                onChange={(e) =>
                  changeBackgroundEffectMode(
                    e.target.value as 'full' | 'top' | 'bottom' | 'center'
                  )
                }
              >
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='particle_density'
                  defaultMessage='Particle Density'
                />
              </SettingName>
              <select
                id='particleDensity'
                ...
                onChange={(e) =>
                  changeParticleDensity(
                    e.target.value as 'low' | 'medium' | 'high' | 'Empty'
                  )
                }
              >
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='particle_opacity'
                  defaultMessage='Particle Opacity'
                />
              </SettingName>
              <input
                id='particleOpacity'
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='wave_trail_color'
                  defaultMessage='Wave Trail Color'
                />
              </SettingName>
              <input
                id='waveTrailColor'
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='wave_trail_opacity'
                  defaultMessage='Wave Trail Opacity'
                />
              </SettingName>
              <input
                id='waveTrailOpacity'
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='main_content_transparency'
                  defaultMessage='Main Content Transparency'
                />
              </SettingName>
              <Switch
            ...
            <Setting>
              <SettingName>
                <FormattedMessage
                  id='particle_effect'
                  defaultMessage='Particle Effect'
                />
              </SettingName>
              <div>
                <ParticleEffectButton
                  ...
                  onClick={() =>
                    changeParticleEffect(
                      particleEffect === 'default' ? 'gravity' : 'default'
                    )
                  }
                >
